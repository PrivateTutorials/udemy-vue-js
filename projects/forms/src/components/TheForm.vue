<!--
with input of type number:
- v-model will give you number
- ref will give String
-->
...
<template>
    <form @submit.prevent="submitForm">
        ...
        <div class="form-control">
            <!-- adding "v-model" not to regular input, but to a custom component -->
    ...
    export default {
        ...
        data() {
            return {
                ...
                userAge: null,
                referrer: 'wom',
                interest: [], // for multiple checkboxes - array
                how: null,
                confirmTerms: false,  // for single checkbox - boolean
